...
export class FormationComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.formationService
      ...
      .subscribe(
        (res: HttpResponse<IFormation[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInFormations(): void {
    this.eventSubscriber = this.eventManager.subscribe('formationListModification', () => this.loadPage());
  }
